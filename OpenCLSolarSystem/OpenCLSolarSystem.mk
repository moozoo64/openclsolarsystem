...
LibPath                := $(LibraryPathSwitch). $(LibraryPathSwitch)"$(OPENCL_LIB64)" $(LibraryPathSwitch)/SDK/glew-1.12.0/lib/Release/x64 
...
PATH:=$(WXWIN)\lib\gcc_dll;C:\SDK\glew-1.12.0\bin\Release\x64;C:\SDK\glew-1.12.0\lib\Release\x64;$(PATH)
WXCFG:=gcc_dll\mswu
