...
WXWIN32:=C:\SDK\wxWidgets-3.0.2
WXWIN64:=C:\SDK\wxWidgets
WXWIN:=$(WXWIN64)
GLEW_INCLUDE:=C:\SDK\glew-1.13.0\include
GLEWBIN32:=C:\SDK\glew-1.13.0\bin\Release\Win32
GLEWBIN64:=C:\SDK\glew-1.13.0\bin\Release\x64
GLEWLIB32:=/SDK/glew-1.13.0/lib/Release/Win32
GLEWLIB64:=/SDK/glew-1.13.0/lib/Release/x64
GLM_INCLUDE:=C:\SDK\glm
OPENCL_INCLUDE:=C:\Program Files (x86)\Intel\OpenCL SDK\6.1\include
OPENCL_LIB32:=C:\Program Files (x86)\Intel\OpenCL SDK\6.1\lib\x86
OPENCL_LIB64:=C:\SDK\OpenCL\lib\x86_64
PATH:=$(PATH);$(WXWIN)\lib\gcc_dll;$(GLEWBIN64)
WXWIN:=$WXWIN64
